...
namespace CSharp.Infrastructure
{
    ...
    public interface IVisitor<in TComponent>
    {
        public Task VisitAsync(TComponent visitor);
    }

    public interface IComponent<out TComponent>
    {
        public Task AcceptAsync(IVisitor<TComponent> visitor);
    }

    public class DefaultVisitor : IVisitor<DefaultComponent>
    {
        public Task VisitAsync(DefaultComponent visitor)
        {
            Console.WriteLine("DefaultVisitor");
            return Task.CompletedTask;
        }
    }

    public class DefaultComponent : IComponent<DefaultComponent>
    {
        public Task AcceptAsync(IVisitor<DefaultComponent> visitor)
        {
            Console.WriteLine("DefaultComponent");
